...
async function generatePoNumber(tx: any) {
...
export const duplicatePurchaseOrder = async (req: Request, res: Response) => {
  try {
...
export const getPurchaseOrderHistory = async (req: Request, res: Response) => {
  try {
